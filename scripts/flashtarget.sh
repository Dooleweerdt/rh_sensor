...
openocd -f board/esp32c3-builtin.cfg -c "gdb memory_map disable" -c "program_esp build/mcuboot/zephyr/zephyr.bin 0x00000000 verify" -c "program_esp build/app/zephyr/zephyr.signed.bin 0x00020000 verify reset exit"
